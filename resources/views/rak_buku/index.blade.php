    ...
    <div class="min-w-screen min-h-screen flex items-center justify-center overflow-hidden">
        <div class="w-full lg:w-5/6">
            <div class="flex items-center py-6">
                ...
                <a class="transition duration-300 ease-in-out mb-2 md:mb-0 bg-green-400 px-5 py-2 text-xs shadow-sm font-small tracking-wider text-white rounded-lg hover:shadow-lg " href="{{ route('rak_buku.create') }}">Tambah Baru</a>
            </div>
                            ...
                            <td class="py-3 px-6 text-center">
                                <form action="{{ route('rak_buku.destroy',$rak_buku->id) }}" method="POST">
                                    ...
                                    <div class="flex item-center justify-center">
                                        <a class="btn btn-info btn-sm" href="{{ route('rak_buku.show',$rak_buku->id) }}">
                                        ...
                                        <a class="btn btn-primary btn-sm" href="{{ route('rak_buku.edit',$rak_buku->id) }}">
                                            <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <button class="btn btn-primary btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data #{{ $rak_buku->id }}?')">
                                            <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
