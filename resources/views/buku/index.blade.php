    ...
    <div class="min-w-screen min-h-screen flex items-center justify-center overflow-hidden">
        <div class="w-full lg:w-5/6">
            <div class="flex items-center py-6">
                ...
                <a class="transition duration-300 ease-in-out mb-2 md:mb-0 bg-green-400 px-5 py-2 text-xs shadow-sm font-small tracking-wider text-white rounded-lg hover:shadow-lg " href="{{ route('buku.create') }}">Tambah Baru</a>
            </div>
