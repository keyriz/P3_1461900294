    ...
    <div class="min-w-screen min-h-screen flex items-center justify-center font-sans overflow-hidden">
        <div class="w-full lg:w-5/6">
            <div class="flex items-center py-6">
                ...
                <a class="transition duration-500 mb-2 md:mb-0 bg-green-400 px-5 py-2 text-xs shadow-sm font-small tracking-wider text-white rounded hover:shadow-lg hover:bg-green-500" href="{{ route('buku.create') }}">Tambah Baru</a>
            </div>
            <!-- Start kode untuk form pencarian -->
            <form class="flex" method="get" action="{{ url()->current() }}">
                <div class="relative text-gray-600">
                    <input type="search" name="cari" placeholder="Search" class="bg-white h-10 px-5 pr-10 rounded text-sm focus:outline-none" value="{{ request('cari') }}">
