        ...
        <div class="w-full lg:w-5/6">
            <div class="bg-white shadow-md rounded-lg p-10">
                <div class="flex flex-col sm:flex-row items-center">
                    ...
                    <a href="{{ route('buku.index') }}" class="transition duration-300 ease-in-out mb-2 md:mb-0 bg-white px-5 py-2 text-sm shadow-sm font-medium tracking-wider border text-gray-600 rounded-lg hover:shadow-lg">Kembali</a>
                </div>
                <div class="mt-5">
                    <p>#{{ $buku->id }}</p>
                    <p>{{ $buku->judul }}</p>
