                    ...
                    <form action="{{ route('buku.store') }}" method="POST" class="form">
                        ...
                        <div class="md:flex flex-row md:space-x-4 w-full text-xs">
                            <div class="mb-3 space-y-2 w-full text-xs">
                                ...
                                <input placeholder="Judul buku..." class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-md h-10 px-4" required="required" type="text" name="judul" id="integration_shop_name">
                            </div>
                        </div>
                        <div class="mb-3 space-y-2 w-full text-xs">
                            ...
                            <div class="flex flex-wrap items-stretch w-full mb-4 relative">
                                ...
                                <input type="number" class="flex-shrink flex-grow flex-auto leading-normal w-px flex-1 border border-l-0 h-10 border-grey-light rounded-md rounded-l-none px-3 relative focus:border-blue focus:shadow" name="tahun_terbit" required="required" min="1900" max="2099" step="1" value="2016">
                            </div>
                        </div>
                        @if ($errors->any())
